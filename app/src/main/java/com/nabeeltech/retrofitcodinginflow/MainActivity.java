...
public class MainActivity extends AppCompatActivity {
    ...
    private Button getposts, commentByPost_Id ,postByUserId,
            ...
            postBodyUrl_two, btn_put, btn_patch, btn_delete , json_object, jsonarray;
    ...
    {
        String url = "https://run.mocky.io/v3/86430898-9445-4969-ae84-a20582ae4e68";
    ...
    {
        String url = "https://run.mocky.io/v3/250af835-d634-427f-aba9-111ccc2ba584";
